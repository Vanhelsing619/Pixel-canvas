...
> _Record a short GIF of two browser windows side by side — paint in one, watch it appear in the other._
> _It's the single best way to show off the real-time sync. Drop it in `/docs` and link it:_
